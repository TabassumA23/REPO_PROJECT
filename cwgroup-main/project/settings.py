...
MIDDLEWARE = [
    ...
    'django.middleware.csrf.CsrfViewMiddleware',  # ⛔ Can be removed if using API-only
...
CORS_ORIGINS_WHITELIST = ["http://localhost:5174"]
...
AUTH_USER_MODEL = 'api.RestaurantSiteUser'